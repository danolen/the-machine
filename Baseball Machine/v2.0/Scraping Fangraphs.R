...
# Example: L7 stats, 7 days after Opening Day 2020

url <- "https://www.fangraphs.com/leaders.aspx?pos=all&stats=bat&lg=all&qual=0&type=c,6,11,12,13,21,34,35,40,41,23,37,38,50,61,305,111,203,199,58,43,44,45,47,102,110,308,311&season=2020&month=1000&season1=2020&ind=0&team=0,ts&rost=0&age=0&filter=&players=0&startdate=2020-07-23&enddate=2020-07-29"
...
# Last 7 days team batting stats (2020)
...
write.csv(team_batting_L7, "team_batting_L7_2020.csv", row.names = FALSE)

# Last 14 days team batting stats (2020)
...
write.csv(team_batting_L14, "team_batting_L14_2020.csv", row.names = FALSE)

# Last 30 days team batting stats (2020)
...
write.csv(team_batting_L30, "team_batting_L30_2020.csv", row.names = FALSE)

# Season-to-date team batting stats (2020)
...
write.csv(team_batting_s2d, "team_batting_s2d_2020.csv", row.names = FALSE)
